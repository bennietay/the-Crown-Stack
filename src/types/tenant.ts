...
export interface EnterpriseOpsHealth {
  generatedAt: string;
  readiness: Array<{
    key: string;
    label: string;
...
export interface LeadRecord {
  ...
  phone?: string;
  email?: string;
  interestType?: "product" | "business" | "event" | "customer" | "team";
  relationshipContext?: string;
  tags?: string[];
  assignedSponsor?: string;
  eventStatus?: "not_invited" | "invited" | "registered" | "reminder_sent" | "attended" | "no_show" | "followed_up" | "converted" | "not_interested";
  purchaseReminderAt?: string;
