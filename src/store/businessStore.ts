...
export const businessContexts: BusinessDefinition[] = [
  ...
  { id: "waas", name: "WAAS — Bennie Studio", shortName: "WAAS", href: "/waas", monetization: "Close website builds and retainers", nav: [{ name: "Operations", href: "/waas", description: "Orders, websites and deployments" }, { name: "Sales & Clients", href: "/leads", description: "Capture and qualify demand" }, { name: "MRR / Pipeline", href: "/pipeline", description: "Move deals to paid" }, { name: "Proposals", href: "/proposals", description: "Send and close offers" }] },
