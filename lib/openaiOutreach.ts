...
export interface OutreachScriptOption {
  type: string;
  description: string;
  message: string;
}
...
function validateScripts(value: unknown): OutreachScriptOption[] {
...
export function getValidatedLeadName(name: unknown) {
  return sanitizeText(name);
}

export async function generateOpenAiOutreachScripts(input: OutreachRequestInput) {
