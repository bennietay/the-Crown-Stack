...
values (
  ...
  array['Know who to follow up with today', 'Recover forgotten prospects', 'Track events, Zooms, and no-shows', 'Duplicate scripts and workflows across your team'],
  array['Prospect and customer CRM with trust notes, relationship score, and next follow-up timing', 'WhatsApp / DM scripts for first contact, event invites, no-show recovery, objections, and reorder reminders', 'Event, webinar, Zoom, and presentation tracker with recovery lists and conversion reports', 'Duplication center for onboarding, shared scripts, team actions, leader notes, and playbooks', 'Stripe-ready pricing, Supabase-ready schema, roles, plan limits, audit logs, legal center, and admin controls'],
  '[{"title":"Prospect & Customer CRM","body":"Track leads, customers, product interest, purchase reminders, trust notes, tags, temperature, and follow-up history."},{"title":"Follow-Up Automation","body":"Build reminders and follow-up sequences that keep outreach timely without sounding robotic."},{"title":"WhatsApp & DM Scripts","body":"Use ready-made scripts for outreach, invites, no-show recovery, objection handling, customer reorder, sponsor handoff, and onboarding."},{"title":"Event & Webinar Tracker","body":"Track invites, registrations, reminders, attendees, no-shows, follow-up actions, conversions, and event-specific scripts."},{"title":"Team Duplication System","body":"Give your team the same scripts, workflows, onboarding plan, action checklist, and leader support path."},{"title":"Reports & Activity Insights","body":"See follow-up activity, event conversion, team momentum, customer reminders, and recovery opportunities."}]'::jsonb,
  '[]'::jsonb,
  '[{"tier":"ignite","name":"Basic","price":"$29","description":"For individual builders who need CRM, follow-up, and scripts.","features":["Prospect CRM","Follow-up reminders","Script library","Customer profiles","Purchase reminders"]},{"tier":"ascent","name":"Growth","price":"$59","description":"For active builders who invite, follow up, and run events weekly.","highlighted":true,"features":["Everything in Basic","Lead capture","Social outreach scripts","AI scripts","Event / appointment tracker","Follow-up sequences","No-show recovery"]},{"tier":"empire","name":"Pro","price":"$99","description":"For team leaders who want to duplicate the system across a team.","features":["Everything in Growth","Team dashboard","Team scripts","Duplication center","Leader analytics","Role permissions","Admin controls"]}]'::jsonb,
  '[{"question":"Does Duplios guarantee sales, income, rank, or customer results?","answer":"No. Duplios is an operating system for organization, follow-up, training, and team workflows. Results depend on the user market, effort, product, compliance, and business model."},{"question":"Is this tied to one network marketing company?","answer":"No. Duplios is company-neutral and designed for relationship-based builders, direct sellers, product educators, and teams."},{"question":"Can I use this with WhatsApp?","answer":"Yes. Duplios helps you personalize, copy, and open WhatsApp-friendly scripts while leaving the actual conversation in your control."},{"question":"Can my team use the same scripts and workflow?","answer":"Yes. Pro workspaces can package scripts, onboarding actions, playbooks, and duplication workflows for team execution."},{"question":"Can I track events, webinars, and no-shows?","answer":"Yes. The event engine tracks invites, registrations, reminders, attendance, no-shows, follow-up, and conversion."},{"question":"Can I use Duplios without being technical?","answer":"Yes. The app is designed as a daily operating system: add the relationship, choose the next action, copy the message, and follow up."},{"question":"Can I cancel anytime?","answer":"Yes. Subscription terms are controlled through Stripe billing and the policies shown at checkout."},{"question":"Can payment be connected after account creation?","answer":"Yes. Users can create a trial workspace first. Stripe billing can be connected when they are ready to activate a paid plan."}]'::jsonb,
  true
)
